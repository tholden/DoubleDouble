classdef QuadDoubleTest < matlab.unittest.TestCase
    ...
    methods ( TestMethodSetup )
        ...
        function CreateTestData( TestCase )
            ...
            TestCase.MediumValues = QuadDouble( [ 1, 2, 3 ] );
            TestCase.LargeValues = QuadDouble( [ 1e10, 2e10, 3e10 ] );
            TestCase.ComplexValues = QuadDouble( [ 1 + 1i, 2 + 2i, 3 + 3i ] );
    ...
    methods ( Test )
        ...
        function TestConstructorFromQuadDouble( TestCase )
            A = QuadDouble( 3.14 );
            B = QuadDouble( A );
        ...
        function TestColon( TestCase )
            A = QuadDouble( 1 ) : QuadDouble( 5 );
            TestCase.verifyEqual( double( A ), 1 : 5 );

            B = QuadDouble( 1 ) : QuadDouble( 0.5 ) : QuadDouble( 3 );
        ...
        function TestSin( TestCase )
            ...
            S = sin( A );
            Expected = [ 0, 0.5, 1 / sqrt( QuadDouble( 2 ) ), sqrt( QuadDouble( 3 ) ) / 2, 1 ];
        ...
        function TestCos( TestCase )
            A = [ 0, QuadDouble.pi / 6, QuadDouble.pi / 4, QuadDouble.pi / 3, QuadDouble.pi / 2 ];
            C = cos( A );
            Expected = [ 1, sqrt( QuadDouble( 3 ) ) / 2, 1 / sqrt( QuadDouble( 2 ) ), 0.5, 0 ];
        ...
        function TestTan( TestCase )
            ...
            T = tan( A );
            Expected = [ 0, 1 / sqrt( QuadDouble( 3 ) ), 1, sqrt( QuadDouble( 3 ) ) ];
        ...
        function TestAsin( TestCase )
            ...
            As = asin( A );
            Expected = [ 0, QuadDouble.pi / 6, QuadDouble.pi / 4, QuadDouble.pi / 3, QuadDouble.pi / 2 ];
        ...
        function TestAtan2( TestCase )
            ...
            X = [ 1, sqrt( QuadDouble( 3 ) ), 1, 1 / sqrt( QuadDouble( 3 ) ) ];
            A = atan2( Y, X );
            Expected = [ 0, QuadDouble.pi / 6, QuadDouble.pi / 4, QuadDouble.pi / 3 ];
        ...
        function TestMod( TestCase )
            A = QuadDouble( [ 7, 7, -7, -7 ] );
            B = QuadDouble( [ 3, -3, 3, -3 ] );
            M = mod( A, B );
        ...
        function TestLU( TestCase )
            A = QuadDouble( [ 2, -1, 0; -1, 2, -1; 0, -1, 2 ] );
            [ L, U, P ] = lu( A );
        ...
        function TestDet( TestCase )
            ...
            B = QuadDouble( [ 1, 2, 3; 4, 5, 6; 7, 8, 9 ] );
            D = det( B );
        ...
        function TestColonMixedTypes( TestCase )
            ...
            A = QuadDouble( 1 ) : 5;
            TestCase.verifyEqual( double( A ), 1 : 5 );
            TestCase.verifyTrue( isa( A, 'QuadDouble' ) );

            B = QuadDouble( 1 ) : 0.5 : 3;
            TestCase.verifyEqual( double( B ), 1 : 0.5 : 3 );
            TestCase.verifyTrue( isa( B, 'QuadDouble' ) );
        end
