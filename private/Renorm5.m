function [ c0, c1, c2, c3 ] = Renorm5( c0, c1, c2, c3, c4 )
    [ c4, c5 ] = EDNormalize( c3, c4 );
    [ c3, c4 ] = EDNormalize( c2, c4 );
    ...
    if any( Select, 'all' )
        ...
        if any( Select3, 'all' )
            ...
            if any( Select3A, 'all' )
                [ s2( Select3A ), s3( Select3A ) ] = EDNormalize( s2( Select3A ), c5( Select3A ) );
            end
            Select3B = Select3 & ~( s2 ~= 0 );
            if any( Select3B, 'all' )
                [ s1( Select3B ), s2( Select3B ) ] = EDNormalize( s1( Select3B ), c5( Select3B ) );
            end
        end
    end
    ...
    if any( Select4, 'all' )
        ...
        if any( Select5, 'all' )
            ...
            if any( Select5A, 'all' )
                [ s2( Select5A ), s3( Select5A ) ] = EDNormalize( s2( Select5A ), c5( Select5A ) );
            end
            Select5B = Select5 & ~( s2 ~= 0 );
            if any( Select5B, 'all' )
                [ s1( Select5B ), s2( Select5B ) ] = EDNormalize( s1( Select5B ), c5( Select5B ) );
            end
        end
        ...
        if any( Select6, 'all' )
            ...
            if any( Select6A, 'all' )
                [ s1( Select6A ), s2( Select6A ) ] = EDNormalize( s1( Select6A ), c5( Select6A ) );
            end
            Select6B = Select6 & ~( s1 ~= 0 );
            if any( Select6B, 'all' )
                [ s0( Select6B ), s1( Select6B ) ] = EDNormalize( s0( Select6B ), c5( Select6B ) );
            end
        end
    end
